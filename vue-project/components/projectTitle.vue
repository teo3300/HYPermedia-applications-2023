<template> <!-- Whole section (bluish) -->
    <div id=main>
        <h1>{{name}}</h1>
        <div id=content> <!-- Actual content -->
            <div id="text-section"> <!-- Text section -->
...
<!-- TODO:
     Content divs (text and image must be side by side -> ltr)
     all the othersrelative positions are top to bottom
-->
<style scoped>
